...
public class ControleDeContatos {
	public static int getCadastrarMensagem() {
		return CADASTRAR_MENSAGEM;
	}

	public static int getVisualizarMensagens() {
		return VISUALIZAR_MENSAGENS;
	}

	public static int getApagarMensagem() {
		return APAGAR_MENSAGEM;
	}

	public static int getAtualizarMensagem() {
		return ATUALIZAR_MENSAGEM;
	}
